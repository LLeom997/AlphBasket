    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4 font-sans">
            <div className="bg-white p-8 rounded-[32px] border border-slate-200 shadow-2xl w-full max-w-md animate-in fade-in zoom-in-95 duration-500">
                ...
                {message && (
                    <div className="mb-6 p-4 bg-brand-green/10 border border-brand-green/10 rounded-2xl flex items-center gap-3 text-brand-green text-xs font-bold animate-in slide-in-from-top-2">
                ...
                <form onSubmit={handleAuth} className="space-y-4">
                    <div className="space-y-1.5">
                        ...
                        <div className="relative">
                            <input
                                ...
                                required
                                className="w-full pl-11 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-2xl text-sm text-slate-900 focus:ring-4 focus:ring-brand-teal/5 focus:border-brand-teal outline-none transition-all placeholder:text-slate-300 font-bold"
                            />
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full bg-brand-teal hover:opacity-90 text-white font-black py-4 rounded-2xl transition-all flex items-center justify-center gap-2 shadow-xl shadow-brand-teal/10 uppercase tracking-widest text-xs disabled:opacity-50"
                    >
                ...
                <div className="mt-8 pt-6 border-t border-slate-100 space-y-4">
                    <button
                        ...
                        className="w-full text-center text-xs font-black text-slate-400 hover:text-brand-teal transition-colors uppercase tracking-widest"
                    >
